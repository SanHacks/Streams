...
<html>
 ...
 ?>">
    <div class="toolbar-inner"><a href="#tab1" class="active tab-link">Top</a><a href="searchlate.php?search=<?php echo"$ss"; ?>" class="tab-link">Latest</a><a href="searchtwitter.php?search=<?php echo"$ss"; ?>" class="tab-link">Search <i class="icon f7-icons">social_twitter_fill</i></a>
 ...
 ?>">
    <div class="toolbar-inner"><a href="#tab1" class="tab-link">Posts</a><a href="searchusers.php?search=<?php echo"$ss"; ?>" class="tab-link">Users</a><a href="location.php?search=<?php echo"$ss"; ?>" class="tab-link">Location</a></div>
  </div>
  </div>
	...
	$hashtag = $_GET['search'];
		...
		LIMIT  30
                             ";
							 	 	 $query=mysqli_query($conn, $queryxc);
		mysqli_close($conn);
...
{				include "connect.php";
		  $queryxcsw ="SELECT avatar,id,username,name FROM users WHERE id='$userwhoid' 
				"; 
				$cools=mysqli_query($conn, $queryxcsw);
