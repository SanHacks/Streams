...
if($post){
    $repost="INSERT INTO likes(post_id,user_id, timestamp,username) 
						...
						mysqli_query($conn, $ORIGINAL);
						
				$notsq="UPDATE posts
						 SET likes = likes + 1
						 WHERE id='$post_id'
						";	
						mysqli_query($conn, $notsq);
