...
<div class="navbar " style="background-color:#0c56ac" >
    <div class="navbar-inner">
      ...
      <div class="center">Publish video</div>
    </div>
  </div>
...
<?php
		echo"				
       		  ...
       		  <form enctype='multipart/form-data' class='store-data list-block' role='form' action='vupload.php' method='POST'>
      <ul>
        <li>
       
		            <div class='item-content'>
            <div class='item-media'><i class='icon f7-icons'>videocam_fill</i></div>
